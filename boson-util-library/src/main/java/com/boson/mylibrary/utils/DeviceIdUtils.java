...
public class DeviceIdUtils {
     ...
     * @param mContext
     */
    public static String getPesudoUniqueID(Context mContext) {
    ...
    public static String getUniqueID(Context mContext) {
        String m_szLongID = /*getIMEI(mContext) +*/ getPesudoUniqueID(mContext)
                + getAndroidID(mContext) + getWLANMACAddress(mContext) + getBTMACAddress(mContext);
//        String m_szLongID = getPesudoUniqueID(mContext) + getWLANMACAddress(mContext) + getBTMACAddress(mContext);
        // compute md5
